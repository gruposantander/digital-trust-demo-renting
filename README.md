...
####  POST /user-info
Set the information stored about the default user inside the demo system. This is the data that is used for the assertions that are made in the consent flow. Request body: 
```
{
    given_name: string,
    family_name: string,
